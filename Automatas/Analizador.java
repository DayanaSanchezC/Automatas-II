...
public class Analizador {
    ...
    private static void malDeclaradas(Token[] tokens, ArrayList<String> simbolo) {
        ...
        for (String variable : variablesIncorrectas) {
            System.err.println("Advertencia: La variable " + variable + " no corresponde al Identificador");
        }
    }
    ...
    public static Token[] procesarArchivo(String nombreArchivo) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(nombreArchivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                // Verificar si la línea está en blanco o contiene solo espacios en blanco
                if (linea.trim().isEmpty()) {
                    System.out.println("Advertencia, se encontraron espacios en blanco.");
